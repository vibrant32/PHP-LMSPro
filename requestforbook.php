...
<div class="wrapper row1">
  <header id="header" class="hoc clear" style="padding-bottom: 13px"> 
    <div id="logo" class="fl_left">
      <h1 style="font-size: 36px"><a href="index.html"><strong>Request for a Book</strong></a></h1>
    </div>
...
<nav class="w3-sidenav w3-black w3-animate-left" style="display:none;z-index:5">
  ...
  <a href="requestformag.php" class="w3-hover-orange">Request for Magazine</a>		
  ...
  <div class="login-box">
      <form action="" method="POST">
          <h1>Requesting a Book</h1>
            ...
            <p>Mobile Number</p>
            <input type="text" name="mobileno" placeholder="Enter Mobile number here" required="">
            <p>Issue Date</p>
...
<?php
	$conn = mysqli_connect("localhost","root","","lms");
		if(isset ($_POST['Submit'])) {
				...
				$date = $_POST['date'];		
				$query = "insert into request_for_book(nameofbook,numofdays,mobileno,date)values('$nameofbook','$numofdays','$mobileno','$date')";
				mysqli_query($conn, $query);
				echo "<script> alert('Your request for Book is issued');</script>";
		}  
?>