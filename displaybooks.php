...
<div class="wrapper row1">
  <header id="header" class="hoc clear" style="padding-bottom: 13px"> 
    <div id="logo" class="fl_left">
      <h1 style="font-size: 36px"><a href="index.html"><strong>Display Books</strong></a></h1>
    </div>
...
<nav class="w3-sidenav w3-black w3-animate-left" style="display:none;z-index:5">
  ...
  <a href="viewrequest.php" class="w3-hover-orange">View Book Requests</a>
  <a href="viewmagrequest.php" class="w3-hover-orange">View Magazine Requests</a>				
  <a href="bookmaster.php" class="w3-hover-orange">Book Master</a>
  <a href="addingmag.php" class="w3-hover-orange">Add Magazine</a>
  <a href="visitorstud.php" class="w3-hover-orange">Visitor Student</a>		
...
<?php 
	...
	if(mysqli_num_rows($result) > 0) {
		echo "
	    <table border = '5' width='100%' class='w3-table w3-bordered w3-card-24'>
	    <tr>		
		<th>Id</th>
		<th>NameOfBook</th>
		<th>Quantity</th>
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			echo "
				...
				<td>".$row['date']."</td>
				<td>"."<p><button class='w3-btn w3-medium w3-round-xlarge'> <a href='updatebookinfo.php?id=$id'> Update </a> </button> </p>
				<p><button class='w3-btn w3-medium w3-round-xlarge'><a href='deletebookinfo.php?id=$id'>Delete</a></button></p>"."</td>
					<td>".$row['status']."</td>
				</tr>
			";		
		}
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear"> 
    <div class="one_quarter first">
      ...
      The main goal of a library management information system is to store, organize, share and retrieve vital information needed to carry out daily operational functions of the library.</p>
