...
{echo "<script>alert('welcome to view book request page');</script>";}
else
...
<div class="wrapper row1">
  <header id="header" class="hoc clear" style="padding-bottom: 13px"> 
    <div id="logo" class="fl_left">
      <h1 style="font-size: 36px"><strong> view request for book</strong></a></h1>
    </div>
...
<nav class="w3-sidenav w3-black w3-animate-left" style="display:none;z-index:5">
  ...
  <a href="displaybooks.php" class="w3-hover-orange">Check Available Books</a>		
	...
	if(mysqli_num_rows($result) > 0) {
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			echo "
				...
				<td>".$row['mobileno']."</td>
				<td>".$row['date']."</td>
				<td>"."<p><button class='w3-btn w3-xlarge w3-round-xlarge'> <a href='issueBook.php?Id=$id'> Agree </a> </button> </p>
				<p><button class='w3-btn w3-xlarge w3-round-xlarge'><a href='rejectBook.php?Id=$id'>Reject </a> </button> </p>"."</td>
					<td>".$row['Status']."</td>
				</tr>
			";		
		}
